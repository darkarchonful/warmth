...
6. Settings: scroll slowly top to bottom so Name, Pairing/Unpair, Help (Contact support, Report a problem or content, Privacy policy), Log out and Delete account are all visible. Tap Unpair, show the confirmation, tap **Cancel**.
7. Log out (confirm).
